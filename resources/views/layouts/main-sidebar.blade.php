...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="{{ route('index') }}"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            @can('الفواتير')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ route('bills.index') }}">قائمة الفواتير</a></li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('bill_details.paied_bills') }}">الفواتير المدفوعة</a></li>
                        @endcan

                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('bill_details.parted_paied_bills') }}">الفواتير المدفوعة
                                    جزئبا</a></li>
                        @endcan

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('bill_details.not_paied_bills') }}">الفواتير غير
                                    المدفوعة</a></li>
                        @endcan

                        @can('الارشيف')
                            <li><a class="slide-item" href="{{ route('bill_archive.archive') }}">الأرشيف </a></li>
                        @endcan
            ...
            @can('الأقسام و المنتجات')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">الأقسام و المنتجات</span><i
