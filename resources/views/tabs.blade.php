                                            ...
                                            <div class=" tab-menu-heading">
                                                <div class="tabs-menu1">
                                                    ...
                                                    <ul class="nav panel-tabs main-nav-line">
                                                        <li><a href="#tab4" class="nav-link active" data-toggle="tab">Tab
                                                                01</a>
                                                        </li>
                                                        <li><a href="#tab5" class="nav-link" data-toggle="tab">Tab 02</a>
                                                        </li>
                                                        <li><a href="#tab6" class="nav-link" data-toggle="tab">Tab 03</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="tab5">
                                                        ...
                                                        <p>Et harum quidem rerum facilis est et expedita distinctio. Nam
                                                            ...
                                                            minus id quod
                                                            maxime</p>
                                                        <p class="mb-0">placeat facere possimus, omnis voluptas assumenda
                                                            est, omnis
                                                            dolor repellendus.</p>
                                                    </div>
                                    ...
                                    <ul class="nav nav-tabs html-source" id="html-source-code2" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active ml-1 html-code" id="html-code2" data-toggle="tab"
                                                ...
                                                aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                                        </li>
                                    </ul>
                                    <!---Prism Pre code-->
                                    <figure class="highlight mb-0" id="element2">
                                        <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="panel panel-primary tabs-style-2">
	<div class=" tab-menu-heading">
		<div class="tabs-menu1">
			<!-- Tabs -->
			<ul class="nav panel-tabs main-nav-line">
                        ...
                        <div class="card mg-b-20" id="tabs-style3">
                            <div class="card-body">
                                ...
                                <div class="text-wrap">
                                                ...
                                                <div class="tabs-menu ">
                                                    ...
                                                    <ul class="nav panel-tabs">
                                                        <li class=""><a href="#tab11" class="active"
                                                                data-toggle="tab"><i class="fa fa-laptop"></i> Tab Style
                                                                01</a></li>
                                                        <li><a href="#tab12" data-toggle="tab"><i
                                                                    class="fa fa-cube"></i> Tab Style
                                                                02</a></li>
                                                        <li><a href="#tab13" data-toggle="tab"><i
                                                                    class="fa fa-cogs"></i> Tab Style
                                                                03</a></li>
                                                        <li><a href="#tab14" data-toggle="tab"><i
                                                                    class="fa fa-tasks"></i> Tab Style
                                                                04</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="tab14">
                                                        <p>On the other hand, we denounce with righteous indignation and
                                                            ...
                                                            moment, so
                                                            blinded by desire</p>
                                                        <p class="mb-0">Nam libero tempore, cum soluta nobis est eligendi
                                                            optio
                                                            cumque nihil impedit quo minus id quod maxime placeat facere
                                                            possimus, omnis
                                    ...
                                    <!---Prism Pre code-->
                                    <figure class="highlight mb-0" id="element3">
                                        <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="panel panel-primary tabs-style-3">
	<div class="tab-menu-heading">
		<div class="tabs-menu ">
			<!-- Tabs -->
			<ul class="nav panel-tabs">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab14">
				...
				<p class="mb-0">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus </p>
                                        ...
                                        <div class="clipboard-icon" data-clipboard-target="#element3"><i
                                                class="las la-clipboard"></i></div>
                                    </figure>
                                    <!---Prism Pre code-->
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-wrap">
                                                        ...
                                                        <div class="tabs-menu ">
                                                            ...
                                                            <ul class="nav panel-tabs ml-3">
                                                                <li class=""><a href="#tab21" class="active"
                                                                        data-toggle="tab"><i class="fa fa-laptop"></i> Tab
                                                                        Style
                                                                        01</a></li>
                                                                <li><a href="#tab22" data-toggle="tab"><i
                                                                            class="fa fa-cube"></i>
                                                                        Tab Style 02</a></li>
                                                                <li><a href="#tab23" data-toggle="tab"><i
                                                                            class="fa fa-cogs"></i>
                                                                        Tab Style 03</a></li>
                                                                <li><a href="#tab24" data-toggle="tab"><i
                                                                            class="fa fa-tasks"></i>
                                                                        Tab Style 04</a></li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="tab23">
                                                            <p>Temporibus autem quibusdam et aut officiis debitis aut rerum
                                                                ...
                                                                sint et
                                                                molestiae non recusandae quod maxime placeat facere
                                                                possimus, omnis
                                                                voluptas assumenda est, omnis dolor repellendus.</p>
                                                            <p>Temporibus autem quibusdam et aut officiis debitis aut rerum
                                                                necessitatibus saepe eveniet ut et voluptates repudiandae
                                                        ...
                                                        <div class="tab-pane" id="tab24">
                                                            <p>On the other hand, we denounce with righteous indignation and
                                                                ...
                                                                pleasure of the
                                                                moment, so blinded by desire quod maxime placeat facere
                                                                possimus, omnis
                                                                voluptas assumenda est, omnis dolor repellendus.</p>
                                                            <p>On the other hand, we denounce with righteous indignation and
                                                                dislike men
                                    ...
                                    <ul class="nav nav-tabs html-source" id="html-source-code4" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active ml-1 html-code" id="html-code4" data-toggle="tab"
                                    ...
                                    <!---Prism Pre code-->
                                    <figure class="highlight mb-0" id="element4">
                                        <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="d-md-flex">
	<div class="">
		<div class="panel panel-primary tabs-style-4">
			<div class="tab-menu-heading">
				<div class="tabs-menu ">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="tab24">
					...
					<p class="mb-0">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus </p>
                                        ...
                                        <div class="clipboard-icon" data-clipboard-target="#element4"><i
                                                class="las la-clipboard"></i></div>
                                    </figure>
                                    <!---Prism Pre code-->
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-wrap">
                                ...
                                <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active ml-1 html-code" id="js-tab" data-toggle="tab"
                                            href="#default-tab" role="tab" aria-controls="default-tab"
                                            aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                                        <a class="nav-link mr-1 html-code" id="js-tab1" data-toggle="tab"
                                            href="#default-tab1" role="tab" aria-controls="default-tab1"
                                            aria-selected="true"><i class="fab fa-node-js text-info mr-2"></i>JS</a>
                                        <a class="nav-link mr-1 html-code" id="js-tab2" data-toggle="tab"
                                            href="#default-tab2" role="tab" aria-controls="default-tab2"
                                            aria-selected="true"><i class="fab fa-node-js text-info mr-2"></i>JS</a>
                                    </li>
                                </ul>
                                ...
                                <!--- tabs -->
                                <div class="tab-content">
                                    <div class="tab-pane active" id="default-tab" role="tabpanel"
                                        aria-labelledby="html-tab">
                                        <!---Prism Pre code-->
                                        <figure class="highlight mb-0" id="element5">
                                            <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="panel panel-primary">
	<div class="tab_wrapper right_tab">
		<ul class="tab_list">
			<li class="active">Tab 1</li>
			<li>Tab 2</li>
		...
		<div class="content_wrapper">
			...
			<div class="tab_content">
				<p> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents .</p>
                                            ...
                                            <div class="clipboard-icon" data-clipboard-target="#element5"><i
                                                    class="las la-clipboard"></i></div>
                                        </figure>
                                    </div>
                                    <div class="tab-pane" id="default-tab1" role="tabpanel" aria-labelledby="js-tab">
                                        <!---Prism Pre code-->
                                        <figure class="highlight mb-0" id="element3">
                                            <pre><code class="language-markup"><script type="prismsmix/javascript"><!---Tabs JS-->
src="{{URL::asset('assets/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
                                    ...
                                    <div class="tab-pane" id="default-tab2" role="tabpanel" aria-labelledby="js-tab1">
                                        <!---Prism Pre code-->
                                        <figure class="highlight mb-0" id="element4">
                                            <pre><code class="language-markup"><script type="prismsmix/javascript"><!---Tabs scripts-->
